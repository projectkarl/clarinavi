...
module.exports=async function handler(req,res){
  ...
  const mode=String(req.query?.mode||'global');res.setHeader('Cache-Control',mode==='contrib'?'s-maxage=45, stale-while-revalidate=120':'s-maxage=15, stale-while-revalidate=60');
  try{
